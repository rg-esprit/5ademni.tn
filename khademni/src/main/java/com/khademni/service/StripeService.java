...
public class StripeService {
    ...
    public String createCheckoutSession(double amount, String description, long contratId) throws Exception {
        ...
        SessionCreateParams sessionParams = SessionCreateParams.builder()
                ...
                .setSuccessUrl("https://5ademni.tn/success?session_id={CHECKOUT_SESSION_ID}&contrat_id=" + contratId)
                .setCancelUrl("https://5ademni.tn/cancel")
                .addLineItem(
     ...
     * Stored in metadata and converted to cents for Stripe (1 € = 100 centimes).
     */
    public String createDepositCheckoutSession(double amountEur, int userId) throws Exception {
        ...
        SessionCreateParams sessionParams = SessionCreateParams.builder()
                .setMode(SessionCreateParams.Mode.PAYMENT)
                .setSuccessUrl("https://5ademni.tn/deposit-success?session_id={CHECKOUT_SESSION_ID}")
                .setCancelUrl("https://5ademni.tn/deposit-cancel")
                                        ...
                                        SessionCreateParams.LineItem.PriceData.builder()
                                                ...
                                                .setProductData(
                                                        SessionCreateParams.LineItem.PriceData.ProductData.builder()
                                                                ...
                                                                .setDescription("Ajout de " + String.format("%.2f", amountEur) + " € à votre solde")
                                                                .build())
                                                .build())
                                .build())
                .build();
     ...
     * Only returns succeeded=true when Stripe reports status = "succeeded" (never update balance before this).
     */
    public DepositVerificationResult retrieveSessionForDeposit(String sessionId) throws Exception {
        ...
        try {
            ...
            if (userIdStr == null || amountEurStr == null) {
                return new DepositVerificationResult(0, 0, null, false, "user_id ou amount_eur manquant dans la session.");
            }
            ...
            return new DepositVerificationResult(userId, amountEur, paymentIntentId, succeeded, succeeded ? null : "Statut paiement: " + paymentStatus);
        } catch (StripeException e) {
